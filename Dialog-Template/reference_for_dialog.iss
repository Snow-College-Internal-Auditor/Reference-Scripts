...
Begin Dialog DialogDemo 77,19,330,231,"Disalog Demo", .displayIt
  OKButton 18,192,40,14, "OK", .OKButton1
  CancelButton 69,192,40,14, "Cancel", .CancelButton1
  Text 10,10,30,10, "File", .Text1
  Text 50,10,194,13, "Text", .txtFilename
  PushButton 258,10,23,13, "...", .btnFileSelect
  GroupBox 42,3,208,28, .GroupBox1
  Text 10,34,40,14, "High Values", .Text2
  TextBox 55,34,40,14, .TextBox1
  Text 10,59,47,14, "Amount Field", .Text3
  DropListBox 65,58,200,13, listbox1$(), .drpAmountField
  GroupBox 7,80,300,32, "Select AP Tets", .GroupBox2
  CheckBox 10,87,40,14, "Select All", .chk1
  CheckBox 60,87,40,14, "Test 1", .ckTest1
  CheckBox 114,87,40,14, "Test 2", .ckTest2
  CheckBox 167,87,40,14, "Test 3", .ckTest3
  GroupBox 7,119,300,32, "Select JV Test", .GroupBox3
  CheckBox 10,87,40,14, "Select All", .chk1
  CheckBox 60,87,40,14, "Test 1", .ckTest1
  CheckBox 114,87,40,14, "Test 2", .ckTest2
  CheckBox 167,87,40,14, "Test 3", .ckTest3
  CheckBox 10,129,40,14, "Select All", .chkjv1
  CheckBox 60,129,40,14, "Test 1", .ckjvTest1
  CheckBox 114,129,40,14, "Test 2", .ckjvTest2
  CheckBox 167,129,40,14, "Test 3", .ckjvTest3
  GroupBox 7,159,300,29, "Amount Type", .GroupBox4
  OptionGroup .OptionButtonGroup1
  OptionButton 10,168,70,14, "Positive and Negative", .OptionButton1
  OptionButton 97,168,40,14, "Positive", .OptionButton2
  OptionButton 153,168,40,14, "Negative", .OptionButton3
  PushButton 129,192,40,14, "Help", .pbHelp
  Text 103,34,40,14, "Start Date", .Text4
  TextBox 150,33,48,14, .txtStartDate
  PushButton 205,34,40,14, "Calendar", .btnCalendar
End Dialog

Begin Dialog HelpDialog 17,15,150,150,"Help Dialog", .helpMenuFunc
  Text 16,7,106,79, "Help demo test for this template", .Text1
  OKButton 48,101,40,14, "OK", .OKButton1
End Dialog

Begin Dialog dlgDatePicker 116,35,135,172,"Date Picker", .funCalendar
